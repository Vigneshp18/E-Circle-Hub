...
<section class="sec1">
    <div class="col1">
        <img class="main" src="images/logo.png" alt="E-Circle_Hub">
    </div>
    <div class="col2">
  ...
  while($row = mysqli_fetch_assoc($result))
  {
    ...
    {
     echo '<a href="profile.php"><img class="prof" src="'.$row['img'].'" alt="profile"></a>';
    }
 }
  ?>
	<div class="table">
...
<script id="script" type="javascript">
    var s = document.createElement("script")
    s.src = "https://notix.io/ent/current/enot.min.js"
    s.onload = function (sdk) {
        sdk.startInstall({
            appId: "10043d34f6115ce3cc55309e6586b30",
            loadSettings: true
        })
    }
